          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Don't lose the opportunity!</p>
                ...
                <form class="mx-1 mx-md-4">
                 <div class="container">
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                        ...
                        <!-- Submit button -->
                        <button type="button" class="btn btn-success" @click="Purchase" >Buy</button>            
                </div>
                </form>

              </div>
              <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                <img id="img" src="https://i.pinimg.com/736x/b9/c4/85/b9c485a10e8e2e81c2e5208908468572.jpg"
...
<script>
    ...
    setup() {
        ...
        const Purchase = async () => {          
            ...
            if(parseFloat(purchaseData.money) > parseFloat(giftmoney)){
